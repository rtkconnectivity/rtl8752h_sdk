...
example:
    ...
    4) OTA Bank1:                                      0K (0x00858000)
        a) OTA Header                    0K (0x00000000)
        b) Patch code                    0K (0x00000000)
        c) Secure boot loader            0K (0x00000000)
        d) BT Stack Patch Code           0K (0x00000000)
        e) Upperstack Code               0K (0x00000000)
        f) APP code                      0K (0x00000000)
    ...
    5) FTL:                                           16K (0x00858000)
    6) OTA Tmp:                                      144K (0x0085C000)
    7) user data1:                            0K (0x00880000)
    8) user data2:                            0K (0x00880000)
    9) MP RF Test Image:                            0K (0x00880000)
*/
...
#define OTA_BANK0_SIZE                  0x00056000  //344K Bytes
#define OTA_BANK1_ADDR                  0x00858000
#define OTA_BANK1_SIZE                  0x00000000  //0K Bytes
#define FTL_ADDR                        0x00858000
#define FTL_SIZE                        0x00004000  //16K Bytes
#define OTA_TMP_ADDR                    0x0085C000
...
#define RF_TEST_IMAGE_ADDR              0x00880000
...
#define BANK0_APP_SIZE                  0x00022000  //136K Bytes
