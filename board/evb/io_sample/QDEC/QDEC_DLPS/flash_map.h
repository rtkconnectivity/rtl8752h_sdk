...
example:
    ...
    3) OTA Bank0:                                    344K (0x00802000)
        ...
        f) APP code                    132K (0x00836000)
        g) APP data1                     0K (0x00857000)
        h) APP data2                     0K (0x00857000)
        i) APP data3                     0K (0x00857000)
        j) APP data4                     0K (0x00857000)
        k) APP data5                     0K (0x00857000)
        l) APP Config File               4K (0x00857000)
...
#define BANK0_APP_SIZE                  0x00021000  //132K Bytes
...
#define BANK0_APP_CONFIG_FILE_ADDR      0x00857000
