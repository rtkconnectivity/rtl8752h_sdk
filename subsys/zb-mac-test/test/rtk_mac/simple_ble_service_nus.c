...
static uint8_t NUS[16] = {GATT_UUID_SIMPLE_PROFILE};
...
const T_ATTRIB_APPL simple_ble_service_tbl[] =
{
    ...
    },
    {
        ...
        {                                          /* type_value */
            GATT_UUID_CHAR_SIMPLE_V2_WRITE
        },
        0,                                          /* bValueLen */
        NULL,
#if SIMP_SRV_AUTHEN_EN
    ...
    },
    {
        (ATTRIB_FLAG_UUID_128BIT | ATTRIB_FLAG_VALUE_APPL),                     /* flags */
        {                                         /* type_value */
            GATT_UUID_CHAR_SIMPLE_V3_NOTIFY
        },
        0,                                          /* bValueLen */
        NULL,
                                            ...
                                            P_FUN_WRITE_IND_POST_PROC *p_write_ind_post_proc)
{
    ...
    *p_write_ind_post_proc = simple_write_post_callback;
    if (SIMPLE_BLE_SERVICE_CHAR_V2_WRITE_INDEX == attrib_index)
    {
        ...
        {
            simp_ble_service_send_v3_notify(0, service_id, p_value, length);
#if 0
            /* Notify Application. */
            TSIMP_CALLBACK_DATA callback_data;
