...
#define SW_SRC_ADDR_MATCH_RETENTION     1    // enable SW to do Source Address Match Filter retention

#define Zigbee_IRQn         ZIGBEE_IRQn
#define Zigbee_Handler      ZIGBEE_Handler
#define Zigbee_VECTORn      ZIGBEE_VECTORn
