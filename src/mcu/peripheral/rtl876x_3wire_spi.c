...
/**
  * @brief  Enables or disables the specified SPI3W peripheral.
...
/**
  * @brief  Enables or disables the specified SPI3W interrupts.
  * @param  SPI3WIRE_INT: specifies the SPI3W interrupts sources to be enabled or disabled.
...
void SPI3WIRE_StartRead(uint8_t address, uint32_t len)
{
    ...
    else
    {
        ...
        SPI3WIRE->CFGR |= (len << SPI3WIRE_SSI_BURST_READ_NUM_Pos);
...
/**
  * @brief  Checks whether the specified SPI3WIRE_FLAG is set or not.
  ...
  * @retval The new state of SPI3WIRE_FLAG (SET or RESET).
  */
