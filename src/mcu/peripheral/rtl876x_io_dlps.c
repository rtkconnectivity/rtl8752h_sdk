...
uint32_t ADC_StoreReg[15];        /*  This array should be placed in RAM ON/Buffer ON.    */
uint16_t AON_StoreReg;
...
void ADC_DLPS_Enter(void)
{
    ...
    AON_StoreReg = btaon_fast_read_safe(0x110);
    ADC_DLPS_ENTER_CONTROL();
...
void ADC_DLPS_Exit(void)
{
    ...
    btaon_fast_write(0x110, AON_StoreReg);
    ADC_DLPS_EXIT_CONTROL();
    return;
}
...
uint32_t GPIO_StoreReg[10];         /*  This array should be placed in RAM ON/Buffer ON.    */
...
void GPIO_DLPS_Enter(void)
{
    ...
    PERIPH->PERI_CLK_CTRL |= (SYSBLK_ACTCK_GPIO_EN_Msk | SYSBLK_SLPCK_GPIO_EN_Msk);
...
void QuadDecoder_DLPS_Enter(void)
{
    ...
    PERIPH->PERI_FUNC0_EN |= SYSBLK_QDECODE_EN_Msk;
    PERIPH->PERI_CLK_CTRL1 |= (SYSBLK_ACTCK_QDECODE_EN_Msk | SYSBLK_SLPCK_QDECODE_EN_Msk);
...
{
    PERIPH->PERI_FUNC0_EN |=  SYSBLK_SPI0_EN_Msk;
    PERIPH->PERI_CLK_CTRL0 |= (SYSBLK_ACTCK_SPI0_EN_Msk | SYSBLK_SLPCK_SPI0_EN_Msk);
...
{
    PERIPH->PERI_FUNC0_EN |=  SYSBLK_SPI1_EN_Msk;
    PERIPH->PERI_CLK_CTRL0 |= (SYSBLK_ACTCK_SPI1_EN_Msk | SYSBLK_SLPCK_SPI1_EN_Msk);
...
void SPI2W_DLPS_Enter(void)
{
    ...
    PERIPH->PERI_FUNC0_EN |=  SYSBLK_SPI2W_EN_Msk;
    PERIPH->PERI_CLK_CTRL1 |= (SYSBLK_ACTCK_SPI2WIRE_EN_Msk | SYSBLK_SLPCK_SPI2WIRE_EN_Msk);
...
/* PWM, use with timer */
uint32_t PWM2_StoreReg;         /*  This array should be placed in RAM ON/Buffer ON.    */
...
void TIM_DLPS_Enter(void)
{
    ...
    TIM_StoreReg[18] = *((volatile uint32_t *)0x4000035CUL);
    TIM_StoreReg[19] = *((volatile uint32_t *)0x40000360UL);
    TIM_StoreReg[20] = *((volatile uint32_t *)0x40000364UL);

    TIM_StoreReg[22] = *((volatile uint32_t *)0x4000600CUL);
    TIM_StoreReg[23] = *((volatile uint32_t *)0x40000384UL);
...
void TIM_DLPS_Exit(void)
{
    ...
    *((volatile uint32_t *)0x4000035CUL) = TIM_StoreReg[18];
    *((volatile uint32_t *)0x40000360UL) = TIM_StoreReg[19];
    *((volatile uint32_t *)0x40000364UL) = TIM_StoreReg[20];
...
void ENHTIM_DLPS_Enter(void)
{
    ...
    ENHTIM_StoreReg[17] = *((volatile uint32_t *)0x40000368UL);

    ENHTIM_StoreReg[18] = *((volatile uint32_t *)0x4000600CUL);
    ENHTIM_StoreReg[19] = *((volatile uint32_t *)0x40000384UL);
...
void ENHTIM_DLPS_Exit(void)
{
    ...
    *((volatile uint32_t *)0x40000368UL) = ENHTIM_StoreReg[17];
...
{
    SYSBLKCTRL->u_210.PERION_REG_SOC_FUNC_EN |= SYSBLK_UART0_EN_Msk;
    SYSBLKCTRL->u_230.PERION_REG_PESOC_CLK_CTRL |= (SYSBLK_ACTCK_UART0_EN_Msk |
                                                    SYSBLK_SLPCK_UART0_EN_Msk);
...
void UART1_DLPS_Enter(void)
{
    ...
    SYSBLKCTRL->u_218.PERION_REG_SOC_PERI_FUNC0_EN |= SYSBLK_UART1_EN_Msk;
    SYSBLKCTRL->u_234.PERION_REG_PESOC_PERI_CLK_CTRL0 |= (SYSBLK_ACTCK_UART1_EN_Msk |
                                                          SYSBLK_SLPCK_UART1_EN_Msk);
...
uint32_t UART2_StoreReg[12];        /*  This array should be placed in RAM ON/Buffer ON.    */
...
void UART2_DLPS_Enter(void)
{
    ...
    SYSBLKCTRL->u_218.PERION_REG_SOC_PERI_FUNC0_EN |= SYSBLK_UART2_EN_Msk;
    SYSBLKCTRL->u_230.PERION_REG_PESOC_CLK_CTRL |= (SYSBLK_ACTCK_UART2_EN_Msk |
                                                    SYSBLK_SLPCK_UART2_EN_Msk);
    ...
    UART2_StoreReg[8] = UART2->RX_IDLE_TOCR;
    UART2_StoreReg[9] = UART2->RX_IDLE_INTCR;
    UART2_StoreReg[10] = UART2->MISCR;
    UART2_StoreReg[11] = UART2->INTMASK;
...
void UART2_DLPS_Exit(void)
{
    ...
    UART2->RX_IDLE_TOCR = UART2_StoreReg[8];
    UART2->RX_IDLE_INTCR = UART2_StoreReg[9];
    UART2->MISCR = UART2_StoreReg[10];
    UART2->INTMASK = UART2_StoreReg[11];
...
void CPU_DLPS_Exit(void)
{
    ...
    NVIC->IP[0] |=  CPU_StoreReg_IP[0] &
                    0xFF00FF00;//skip restore the priority of System_IRQn(#0) and BTMAC_IRQn(#2)
    for (i = 1; i < 8; ++i)
    {
...
//    DBG_DIRECT("DLPS_IO_EnterDlpsCb");
    ...
    {
        btaon_fast_write_safe_8b(BTAON_FAST_RESET_REASON, RESET_REASON_POWERDOWN);
    }
...
{
    dlps_hw_control_cb_reg(DLPS_IO_EnterDlpsCb, PLATFORM_PM_ENTER);
