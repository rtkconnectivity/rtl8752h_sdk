...
;/*****************************************************************************/
;/*  startup_rtl8762c_gcc.s: Startup file for Realtek RTL87X2H device series  */
;/*****************************************************************************/
...
g_pfnVectors:
  ...
  .word TMETER_Handler                   /*[1]  TMETER global insterrupt*/
  ...
  .word BTMAC_WRAP_AROUND_Handler        /*[5]  BTMAC_WRAP_AROUND interrupt*/
  ...
  .word ZIGBEE_Handler                   /*[9]  ZIGBEE interrupt*/
  .word PF_RTC_Handler                   /*[10] Platform RTC interrupt*/
  .word UART0_Handler                    /*[11] Uart0 interrupt*/
  .word UART1_Handler                    /*[12] Uart1 interrupt*/
  .word I8080_Handler                    /*[13] I8080 interrupt*/
  ...
  /* Interrupt name, Interrupt Number, Interrupt status bit, Offset in vector */
  .word SPIC0_Handler                    /* 19, 0, 50  */
  .word Qdecode_Handler                  /* 19, 1, 51  */
  .word Keyscan_Handler                  /* 19, 2, 52  */
  .word SPI2W_Handler                    /* 19, 3, 53  */
  .word LPCOMP_Handler                   /* 19, 4, 54  */
  .word PTA_Mailbox_Handler              /* 19, 5, 55  */
  .word SPIC1_Handler                    /* 19, 6, 56  */
  .word SHA256_Handler                   /* 19, 7, 57  */
  .word Platform_Handler                 /* 19, 8, 58  */
  .word TRNG_Handler                     /* 19, 9, 59  */
  .word FLASH_SEC_Handler                /* 19, 10, 60  */
  .word RTC_Handler                      /* 19, 11, 61  */
  .word WDT_Handler                      /* 19, 12, 62  */
...
*/
  ...
  .weak  BTMAC_WRAP_AROUND_Handler
  .thumb_set Timer2_Handler,Default_Handler
  ...
  .weak  PF_RTC_Handler
  .thumb_set PF_RTC_Handler,Default_Handler
  ...
  .weak  FLASH_SEC_Handler
  .thumb_set FLASH_SEC_Handler,Default_Handler
