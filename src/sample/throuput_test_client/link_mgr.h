...
/** @addtogroup  THROUPUT_TEST_CLIENT_SRV_DIS
    * @{
    */
...
#define APP_DISCOV_TPS_FLAG     0x02
/**
  * @}
  */
/** @} */
/** @addtogroup  THROUPUT_TEST_CLIENT_GAP_MSG
    * @{
    */
/**
...
/** @} */ /* End of group THROUPUT_TEST_CLIENT_GAP_MSG */
/** @addtogroup  THROUPUT_TEST_CLIENT_SCAN_MGR
    * @{
    */
/**
