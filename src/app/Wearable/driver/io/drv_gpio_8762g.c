...
void DRV_GPIO_A14_Handler(void) {DRV_GPIO_HANDLER(P1_6);}
void DRV_GPIO_A15_Handler(void) {DRV_GPIO_HANDLER(P1_7);}
void DRV_GPIO_A16_Handler(void) {DRV_GPIO_HANDLER(MICBIAS);}
void DRV_GPIO_A17_Handler(void) {DRV_GPIO_HANDLER(XI32K);}
void DRV_GPIO_A18_Handler(void) {DRV_GPIO_HANDLER(XO32K);}
void DRV_GPIO_A19_Handler(void) {DRV_GPIO_HANDLER(DACP);}
void DRV_GPIO_A20_Handler(void) {DRV_GPIO_HANDLER(DACN);}
void DRV_GPIO_A21_Handler(void) {DRV_GPIO_HANDLER(P2_0);}
void DRV_GPIO_A22_Handler(void) {DRV_GPIO_HANDLER(P2_1);}
void DRV_GPIO_A23_Handler(void) {DRV_GPIO_HANDLER(P2_2);}
void DRV_GPIO_A24_Handler(void) {DRV_GPIO_HANDLER(P2_3);}
void DRV_GPIO_A25_Handler(void) {DRV_GPIO_HANDLER(P2_4);}
void DRV_GPIO_A26_Handler(void) {DRV_GPIO_HANDLER(P2_5);}
void DRV_GPIO_A27_Handler(void) {DRV_GPIO_HANDLER(P2_6);}
void DRV_GPIO_A28_Handler(void) {DRV_GPIO_HANDLER(P2_7);}
void DRV_GPIO_A29_Handler(void) {DRV_GPIO_HANDLER(P3_0);}
void DRV_GPIO_A30_Handler(void) {DRV_GPIO_HANDLER(P3_1);}
void DRV_GPIO_A31_Handler(void) {DRV_GPIO_HANDLER(P3_2);}


void DRV_GPIO_B0_Handler(void) {DRV_GPIO_HANDLER(P3_3);}
void DRV_GPIO_B1_Handler(void) {DRV_GPIO_HANDLER(P3_4);}
void DRV_GPIO_B2_Handler(void) {DRV_GPIO_HANDLER(P3_5);}
void DRV_GPIO_B3_Handler(void) {DRV_GPIO_HANDLER(P3_6);}
void DRV_GPIO_B4_Handler(void) {DRV_GPIO_HANDLER(P3_7);}
void DRV_GPIO_B5_Handler(void) {DRV_GPIO_HANDLER(P4_0);}
void DRV_GPIO_B6_Handler(void) {DRV_GPIO_HANDLER(P4_1);}
void DRV_GPIO_B7_Handler(void) {DRV_GPIO_HANDLER(P4_2);}
void DRV_GPIO_B8_Handler(void) {DRV_GPIO_HANDLER(P4_3);}
void DRV_GPIO_B9_Handler(void) {DRV_GPIO_HANDLER(P4_4);}
void DRV_GPIO_B10_Handler(void) {DRV_GPIO_HANDLER(P4_5);}
void DRV_GPIO_B11_Handler(void) {DRV_GPIO_HANDLER(P4_6);}
void DRV_GPIO_B12_Handler(void) {DRV_GPIO_HANDLER(P4_7);}
void DRV_GPIO_B13_Handler(void) {DRV_GPIO_HANDLER(P5_0);}
void DRV_GPIO_B14_Handler(void) {DRV_GPIO_HANDLER(P5_1);}
void DRV_GPIO_B15_Handler(void) {DRV_GPIO_HANDLER(P5_2);}
void DRV_GPIO_B16_Handler(void) {DRV_GPIO_HANDLER(P5_3);}
void DRV_GPIO_B17_Handler(void) {DRV_GPIO_HANDLER(P5_4);}
void DRV_GPIO_B18_Handler(void) {DRV_GPIO_HANDLER(P5_5);}
void DRV_GPIO_B19_Handler(void) {DRV_GPIO_HANDLER(P5_6);}
void DRV_GPIO_B20_Handler(void) {DRV_GPIO_HANDLER(P5_7);}
//void DRV_GPIO_B19_Handler(void) {DRV_GPIO_HANDLER(P6_0);}
//void DRV_GPIO_B20_Handler(void) {DRV_GPIO_HANDLER(P6_1);}
void DRV_GPIO_B21_Handler(void) {DRV_GPIO_HANDLER(P6_2);}
void DRV_GPIO_B22_Handler(void) {DRV_GPIO_HANDLER(P6_3);}
void DRV_GPIO_B23_Handler(void) {DRV_GPIO_HANDLER(P6_4);}
void DRV_GPIO_B24_Handler(void) {DRV_GPIO_HANDLER(P6_5);}
void DRV_GPIO_B25_Handler(void) {DRV_GPIO_HANDLER(P6_6);}
void DRV_GPIO_B26_Handler(void) {DRV_GPIO_HANDLER(P6_7);}
void DRV_GPIO_B27_Handler(void) {DRV_GPIO_HANDLER(P7_0);}
void DRV_GPIO_B28_Handler(void) {DRV_GPIO_HANDLER(P7_1);}
void DRV_GPIO_B29_Handler(void) {DRV_GPIO_HANDLER(P7_2);}
void DRV_GPIO_B30_Handler(void) {DRV_GPIO_HANDLER(P7_3);}
void DRV_GPIO_B31_Handler(void) {DRV_GPIO_HANDLER(P7_4);}
