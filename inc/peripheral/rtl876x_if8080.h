 ...
 *============================================================================*/
/**
 * \defgroup   IF8080_Exported_Types   IF8080 Exported Types
 *
 * \ingroup     IF8080
 */
...
typedef struct
{
    uint32_t IF8080_ClockDiv;               /*!< Specify the IF8080 clock speed. */
    uint32_t IF8080_Mode;                   /*!< Specify the IF8080 operation mode. */
    uint32_t IF8080_AutoModeDirection;      /*!< Specify the IF8080 read or write operation. */
    uint32_t IF8080_InitGuardTimeCmd;       /*!< Specify the init guard time function. */
    uint32_t IF8080_InitGuardTime;          /*!< Specify the guard time. This parameter is 0~3T of divider clock. */
    uint32_t IF8080_CmdGuardTimeCmd;        /*!< Specify the command guard time function. */
    uint32_t IF8080_CmdGuardTime;           /*!< Specify the guard time. This parameter is 0~3T of divider clock. */
    uint32_t IF8080_GuardTimeCmd;           /*!< Specify the guard time function. The guard time is only available for hardware continuously write mode. */
    uint32_t IF8080_GuardTime;              /*!< Specify the guard time. This parameter is 0~3T of divider clock. */
    uint32_t IF8080_WRDelay;                /*!< Specify the delay time for WR. This parameter is half or one bus clock cycle. */
    uint32_t IF8080_8BitSwap;               /*!< Specify the FIFO data format. */
    uint32_t IF8080_16BitSwap;              /*!< Specify the FIFO data format. */
    uint32_t IF8080_TxThr;                  /*!< Specify the TX FIFO threshold value. This value can be from 0 to 16. */
    uint32_t IF8080_TxDMACmd;               /*!< Specify the TX DMA status in auto mode. */
    uint32_t IF8080_VsyncCmd;               /*!< Specify the Vsync signal. */
    uint32_t IF8080_VsyncPolarity;          /*!< Specify the Vsync trigger polarity. */
} IF8080_InitTypeDef;

/** End of IF8080_Exported_Types
  * \}
  */
...
/* Register: CTRL1 -------------------------------------------------------*/
/* Description: Control register 1. Offset: 0x04. Address: 0x40024804. */
...
/* CTRL1[1]: IF8080_TX_DMA_SINGLE_LOW. */
#define IF8080_TX_DMA_VSYNC_EN_POS       (1)
#define IF8080_TX_DMA_VSYNC_EN_MSK       (0x1 << IF8080_TX_DMA_VSYNC_EN_POS)
#define IF8080_TX_DMA_VSYNC_EN_CLR       (~IF8080_TX_DMA_VSYNC_EN_MSK)
...
#define IF8080_WR_TRIGGER_DELAY_CTRL_MSK   ((unsigned int)0x3 << IF8080_WR_TRIGGER_DELAY_CTRL_POS)
 ...
 *============================================================================*/
/**
 * \defgroup    IF8080_Exported_Constants IF8080 Exported Constants
 *
 * \ingroup     IF8080
 */
...
/**
 * \defgroup    IF8080_Clock_Div IF8080 Clock Div
 * \{
 * \ingroup     IF8080_Exported_Constants
 */
...
/** End of IF8080_Exported_Constants
  * \}
  */
 ...
 *============================================================================*/
/**
 * \defgroup    IF8080_Exported_Functions IF8080 Exported Functions
 * \{
 * \ingroup     IF8080
 */

/**
 * \brief   Deinitialize the IF8080 peripheral registers to their default values.
 * \return  None.
 *
 * <b>Example usage</b>
 * \code{.c}
 ...
 *      This parameter can be one of the following values, which refers to \ref IF8080_Pin_Group.
...
/**
 * \brief   Initialize the IF8080 peripheral according to the specified
 *          parameters in the IF8080_InitStruct.
 * \param[in] IF8080_InitStruct: Pointer to an IF8080_InitTypeDef structure that
...
/**
 * \brief  Fill each IF8080_InitStruct member with its default value.
 ...
 * \param[in]  IF8080_Direction: The IF8080 read or write operation.
 *     This parameter can be one of the following values, which refer to \ref IF8080_Auto_Mode_Direction.
 *     \arg IF8080_Auto_Mode_Direction_READ: Write operation.
 *     \arg IF8080_Auto_Mode_Direction_WRITE: Read operation.
 ...
 * \param[in] cmd: Command which is to be sent.
 * \return None.
 *
 * <b>Example usage</b>
 * \code{.c}
 ...
 * \param[out] pBuf: Buffer address to be received.
 * \param[in] len: Data length.
 * \return None.
 *
 * <b>Example usage</b>
 ...
 * \param[in]  pCmdBuf: Buffer address which stores command sequence.
 ...
 * \param[in]  IF8080_INT_MSK: Specify the IF8080 interrupt sources to be masked or unmasked.
 *      This parameter can be the following values, which refer to \ref IF8080_Interrupts_Mask_Definition.
 ...
 *      This parameter can be one of the following values, which refer to \ref IF8080_Interrupts_Definition.
 *      \arg IF8080_INT_SR_VSYNC: Vsync trigger interrupt.
 ...
 * \return The new state of IF8080_INT (SET or RESET).
 *
 * <b>Example usage</b>
 * \code{.c}
 *
 ...
 *      This parameter can be one of the following values, which refer to \ref IF8080_Flag_Definition.
 *     \arg IF8080_FLAG_RF_EMPTY: Rx FIFO empty flag.
 *     \arg IF8080_FLAG_RF_FULL: Rx FIFO full flag.
 *     \arg IF8080_FLAG_TF_EMPTY: Tx FIFO empty flag.
 *     \arg IF8080_FLAG_TF_FULL: Tx FIFO full flag.
 * \return The new state of IF8080_FLAG (SET or RESET).
 *
 * <b>Example usage</b>
 * \code{.c}
 *
 ...
 * \param[in]  IF8080_LLIGroup1: Pointer to an IF8080_GDMALLITypeDef structure that
 *             contains the group 1 configuration information for the IF8080 GDMA peripheral.
 * \param[in]  IF8080_LLIGroup2: Pointer to an IF8080_GDMALLITypeDef structure that
 *             contains the group 2 configuration information for the IF8080 GDMA peripheral.
 * \param[in]  IF8080_LLP_Group1Offset: Pointer to an IF8080_GDMALLIOFTTypeDef structure that
 *             contains the group 1 offset configuration information for the GDMA transmission.
 * \param[in]  IF8080_LLP_Group2Offset: Pointer to an IF8080_GDMALLIOFTTypeDef structure that
 ...
 *      This parameter can be the following values, which refer to \ref IF8080_Mode.
...
/**
 * \brief  Set CS signal in manual mode.
 * \return None.
 *
 * <b>Example usage</b>
 * \code{.c}
...
/**
 * \brief  Reset CS signal in manual mode.
 * \return None.
 *
 * <b>Example usage</b>
 * \code{.c}
 ...
 * \param[in] IF8080_INT: Specify the interrupt pending bit to clear.
 *      This parameter can be any combination of the following values, which refer to \ref IF8080_Interrupts_Clear_Status.
 ...
 * \param[in]  data: Data to be written in FIFO.
 * \return None.
 *
 * <b>Example usage</b>
 * \code{.c}
...
/**
  ...
  * \return None
  */
__STATIC_INLINE void IF8080_GDMAVsyncEnable(FunctionalState NewState)
{
    /* Check the parameters */
    assert_param(IS_FUNCTIONAL_STATE(NewState));
    ...
    if (NewState == ENABLE)
    {
        IF8080->CTRL1 |= IF8080_TX_DMA_VSYNC_EN_MSK;
    }
    else
    {
        IF8080->CTRL1 &= IF8080_TX_DMA_VSYNC_EN_CLR;
    }
}

/** End of IF8080_Exported_Functions
  * \}
  */
