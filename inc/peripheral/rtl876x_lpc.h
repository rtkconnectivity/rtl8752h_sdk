...
typedef struct
{
    uint16_t LPC_Channel;           /*!< Specify the input pin.
                                            This parameter can be a value of \ref LPC_Channel. */
    uint32_t LPC_Edge;              /*!< Specify the comparator output edge.
                                            This parameter can be a value of \ref LPC_Edge. */
    uint32_t LPC_Threshold;         /*!< Specify the threshold value of comparator voltage.
...
/* LPC_AON_52[5:0] : LPC_Threshold. Specify the threshold value of comparator voltage */
...
/* LPC_AON_114[5] : LPC_Edge. Specify the cmp output edge */
#define LPC_AON_114_POSEDGE_Pos         (5UL)
#define LPC_AON_114_POSEDGE_Msk         (0x1UL << LPC_AON_114_POSEDGE_Pos)
/* LPC_AON_114[4:1] : LPC_Channel. Specify the input pin */
 ...
 *      This parameter can be one of the following values, which refer to \ref LPC_Interrupts_Definition.
 *      \arg LPC_INT_LPCOMP_VOL: Voltage detection interrupt source. If Vin<Vth, cause this interrupt.
 *      \arg LPC_INT_LPCOMP_CNT: Counter comparator interrupt source.
...
/**
 * \brief  Check whether the specified LPC interrupt is set or not.
 * \param[in]  LPC_FLAG: Specify the LPC interrupt to check.
 *       This parameter can be one of the following values, which refer to \ref LPC_Flags_Definition.
 *       \arg LPC_FLAG_LPCOMP_AON: counter comparator AON flag.
 *       \arg LPC_FLAG_LPCOMP_CNT: counter comparator flag.
 * \return LPC_FLAG: The new state of LPC_INT (SET or RESET).
 */
FlagStatus LPC_GetFlagStatus(uint32_t LPC_FLAG);

/**
 * \brief  Clear the specified LPC flag.
 * \param[in]  LPC_FLAG: Specify the LPC flag to clear.
 *   This parameter can be one of the following values:
 *     \arg LPC_FLAG_LPCOMP_CNT: counter comparator flag.
 * \return None.
 */
 ...
 * \param[in]  LPC_INT: Specify the LPC interrupt to check.
 *   This parameter can be one of the following values:
 *     \arg LPC_INT_LPCOMP_CNT: counter comparator interrupt.
 ...
 * \param[in] LPC_INT: Specify the LPC interrupt to clear.
 *      This parameter can be one of the following values:
 *      \arg LPC_INT_LPCOMP_CNT: Counter comparator interrupt.
 * \return  None.
 *
