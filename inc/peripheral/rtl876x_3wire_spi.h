 ...
 *
 * \brief       Manage the SPI3W peripheral functions.
 *
 * \ingroup     IO
 */
...
typedef struct
{
    ...
    uint32_t SPI3WIRE_Speed;        /**< Specify SPI3W clock. */
    uint32_t SPI3WIRE_Mode;         /**< Specify SPI3W operation mode.
                                         This parameter can be a value of \ref SPI3W_Mode. */
    uint32_t SPI3WIRE_ReadDelay;    /**< Specify the delay time from the end of the address phase to the start of the read data phase.
                                         This parameter can be a value of 0x0 to 0x1f. delay time = (SPI3WIRE_ReadDelay+1)/(2*SPI3WIRE_Speed). */
    uint32_t SPI3WIRE_OutputDelay;  /**< Specify SPI output delay 1T or not.
                                         This parameter can be a value of \ref SPI3W_OE_Delay_Config. */
    uint32_t SPI3WIRE_ExtMode;      /**< Specify extended timing window for SPI output enable = 0. The extended time is 1/(2*SPI_CLK).
...
/* Peripheral: SPI3W */
/* Description: SPI3W register defines */

/* Register: CFGR ------------------------------------------------------------*/
/* Description: SPI3W configuration register. Offset: 0x30. Address: 0x40004030. */

/* CFGR[31] : SPI3WIRE_SSI_EN. 0x1: enable SPI3W mode. 0x0: disable SPI3W mode. */
...
/* Note: Using this control bit can extend the timing window for SPI output enable = 0. The extended time is 1/(2*SPI_CLK) */
...
/* Register: CR ------------------------------------------------------------*/
/* Description: SPI3W control register. Offset: 0x34. Address: 0x40004034. */
...
/* Register: INTCR ------------------------------------------------------------*/
/* Description: SPI3W interrupt clear register. Offset: 0x38. Address: 0x40004038. */

/* INTCR[31] : SPI3WIRE_RESYNV_EN. 0x1: trigger resync signal. 0x0: disable resync signal. */
...
/* Register: SR ------------------------------------------------------------*/
/* Description: SPI3W status register. Offset: 0x3C. Address: 0x4000403C. */
...
/* SR[0] : SPI3WIRE_RDATA_NUM. The total number of data bytes in each SPI read transaction. */
...
/**
 * \brief   Initialize the SPI3W peripheral according to the specified
...
/**
 * \brief   Fill each SPI3WIRE_InitStruct member with its default value.
 ...
 * \param[in] SPI3WIRE_INT: Specify the SPI3W interrupt sources to be enabled or disabled.
 *      This parameter can be only the following value:
 *      \arg SPI3WIRE_INT_BIT: When reading state ends, SPI3W interrupt will be triggered.
 ...
 *      This parameter can be only the following value: 0x0 to 0xf.
 * \return  None.
 *
 * <b>Example usage</b>
 * \code{.c}
...
/**
 * \brief   Send resync signal or not. Must send when SPI3W is disabled.
 * \param[in] NewState: New state of the SPI3W peripheral.
 *      This parameter can be only the following value:
...
/**
 * \brief   Get the total number of data bytes in each SPI reading.
 * \return  The total number of data bytes in each SPI reading.
 *
 * <b>Example usage</b>
 * \code{.c}
 *
 ...
 *      \arg SPI3WIRE_FLAG_BUSY: SPI3W is busy.
 *      \arg SPI3WIRE_FLAG_INT_IND: There is SPI3W interrupt.
 *      \arg SPI3WIRE_FLAG_RESYNC_BUSY: Resync busy or not.
 * \return  The new state of the specified SPI3W_Flag, SET or RESET.
 *
 * <b>Example usage</b>
 * \code{.c}
 *
 ...
 * \param[in] SPI3WIRE_INT: Specify the SPI3W interrupt source to enable or disable.
