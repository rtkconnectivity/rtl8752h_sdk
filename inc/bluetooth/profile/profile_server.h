...
/** @defgroup GATT_SERVER_Exported_Types GATT Server Exported Types
  ...
  * @{
  */
/** @defgroup GATT_SERVER_TYPES_DEFs GATT Server Types Definitions
  * @{
  */
...
/** @defgroup T_FUN_SERVER_CBS Specific Service Callback Functions Struct
  * @{
  */
typedef struct
{
 ...
 *
 * If sending request operation is success, the result of clear service will be returned by callback
 * registered by @ref server_register_app_cb with eventId @ref PROFILE_EVT_SRV_CLEAR_AFTER_INIT_COMPLETE.
 *
 ...
 *
 * @return Send request operation result.
 ...
 *
 * If result is true, the added services will be registered when @ref server_set_service_reg_mode
 * is called again with param @ref SERVICE_REG_MODE_ADD_TO_STACK.
 *
