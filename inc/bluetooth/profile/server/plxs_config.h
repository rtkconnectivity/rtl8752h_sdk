...
/** @defgroup PLXS_Service_CONFIG PLXS Config
...
/** @defgroup PLXS_Common_Exported_Macros PLXS Common Exported Macros
  * @{
  */
/** @defgroup PLXS_Common_DEFs PLXS Common Definitions
  * @{
  */
...
/** @brief Define PLX service features which measurement status are supported. This macro, according to user needs, can be added,
  *        for example:
  ...
  *        This means both PLXS_FEATURES_MEASUREMENT_STATUS_ONGOING_SUPPORT and PLXS_FEATURES_MEASUREMENT_STATUS_FULLY_QUALIFIED_DATA_SUPPORT are supported. If other supports need to be added,
  *        please refer to The Measurement Status Support field above.
  */
#define PLXS_FEATURES_MEASUREMENT_STATUS_SUPPORTS                                                     (PLXS_FEATURES_MEASUREMENT_STATUS_ONGOING_SUPPORT | PLXS_FEATURES_MEASUREMENT_STATUS_FULLY_QUALIFIED_DATA_SUPPORT)
...
#define PLXS_FEATURES_DEVICE_SENSOR_STATUS_NONPULSATILE_SIGNAL_DETECTED_SUPPORT                       0x000080 /**< Non-pulsatile Signal Detected bit supported. */
...
/** @brief Define PLX service features which device and sensor status are supported. According to user needs, these can be added,
  *        for example:
  ...
  *        This means both PLXS_FEATURES_DEVICE_SENSOR_STATUS_EXTENDED_DISPLAY_UPDATE_ONGOING_SUPPORT and PLXS_FEATURES_DEVICE_SENSOR_STATUS_SENSOR_DISCONNECTED_SUPPORT are supported. If other supports need to be added,
  *        please refer to the Device and Sensor Status Support field above.
  */
#define PLXS_FEATURES_DEVICE_SENSOR_STATUS_SUPPORTS                                                  (PLXS_FEATURES_DEVICE_SENSOR_STATUS_EXTENDED_DISPLAY_UPDATE_ONGOING_SUPPORT | PLXS_FEATURES_DEVICE_SENSOR_STATUS_SENSOR_DISCONNECTED_SUPPORT)
/** @} End of PLXS_Common_DEFs */

/** @defgroup PLXS_Service_ATTR_INDEX PLXS Service Attribute Index
...
#endif
/** @} End of PLXS_Service_ATTR_INDEX */
