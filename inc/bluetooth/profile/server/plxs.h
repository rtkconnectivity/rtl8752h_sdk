...
*****************************************************************************************
  * @file     plxs.h
  * @brief    Header file for using Pulse Oximeter Service.
...
/** @brief  Spot check measurement value indicate, continuous measurement value notify or racp procedure status  */
typedef enum
{
...
/** @defgroup PLXS_Exported_Functions PLXS Exported Functions
  ...
  */
/**
  * @brief  Add PLX service to the LE Host database.
  *
  * @param[in] p_func  Callback when service attribute was read, write or CCCD update.
  * @return Service id generated by the LE Host: @ref T_SERVER_ID.
...
/**
  ...
  *
  * @param[in] param_type  Service parameter type: @ref T_PLXS_PARAM_TYPE.
  * @param[in,out] p_value  Get spot check measurement flags, continuous measurement flags, or features supports.
  * @return Operation result @ref T_PLXS_APP_RESULT.
  ...
  * \code{.c}
    void test(void)
    {
        ...
        T_PLXS_APP_RESULT result = plxs_get_parameter(PLXS_PARAM_FEATURE_FLAGS, &plxs_features);
  * \endcode
  */
...
/**
  ...
  * @param[in] Service_id  Generated by the LE Host: @ref T_SERVER_ID.
  * @param[in] p_spot_check_measurement_value Spot check measurement value: @ref T_PLXS_SPOT_CHECK_MEASUREMENT_VALUE.
  * @return Operation result @ref T_PLXS_APP_RESULT.
  * @retval PLXS_APP_RESULT_SUCCESS Operation success.
  * @retval Others Operation fail.
  *
  ...
  * \code{.c}
     void test(void)
     {
        ...
        T_PLXS_APP_RESULT result = plxs_spot_check_measurement_value_indicate(conn_id, plxs_srv_id, &plxs_spot_check_measure_value);
     }
  * \endcode
  */
...
/**
  ...
  * @param[in] conn_id  Connection ID.
  * @param[in] Service_id  Generated by the LE Host: @ref T_SERVER_ID.
  * @param[in] p_plxs_continuous_measurement_value Continuous measurement value: @ref T_PLXS_CONTINUOUS_MEASUREMENT_VALUE.
  * @return Operation result @ref T_PLXS_APP_RESULT.
  * @retval PLXS_APP_RESULT_SUCCESS Operation success.
  * @retval Others Operation fail.
  *
  ...
  * \code{.c}
     void test(void)
     {
        T_PLXS_CONTINUOUS_MEASUREMENT_VALUE plxs_continuous_measurement_value;
...
/**
  ...
  * @param[in] conn_id  Connection ID.
  * @param[in] service_id  Generated by the LE Host: @ref T_SERVER_ID.
  * @param[in] attribute_index  Attribute index.
  *
  * <b>Example usage</b>
  * \code{.c}
