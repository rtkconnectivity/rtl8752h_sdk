...
typedef struct otp_struct
{
    ...
    uint32_t ftl_enable_write_skip : 1; /*if enabled, if read value equals write value will skip*/
    ...
    uint32_t reboot_record_item_limit_power_2 : 4;   /* max number of reboot records (2^n), 0x002003c0*/
